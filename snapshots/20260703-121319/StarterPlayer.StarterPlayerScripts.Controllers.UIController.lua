...
function UIController.Init(ui, notifications, guidance)
	...
	if watermark then
		watermark.Visible = GameConfig.LaunchMode ~= "Production" and (GameConfig.PrivateTest or {}).ShowDebugWatermark == true
		watermark.Text = "PRIVATE TEST | " .. tostring(GameConfig.Phase or "Phase 9")
	end
	bindRemotes()
