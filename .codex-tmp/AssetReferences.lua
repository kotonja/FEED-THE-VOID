local AssetReferences = {
	...
	PhantomSnack = {
		...
		DefaultScale = 1,
		Description = "Phantom Snack Chase collectible; uses the round snack mesh until a dedicated phantom mesh is imported.",
	},
	GrowPlate = {
	...
	UpgradeStation = {
		Path = { "Workspace", "GameWorld", "Plots", "Plot1", "Visuals", "UpgradeStationVisual" },
		FallbackType = "Station",
		DefaultScale = 1,
		Description = "Upgrade station visual from the live plot model.",
	},
	RebirthPortal = {
		Path = { "Workspace", "GameWorld", "Plots", "Plot1", "Visuals", "RebirthVisual" },
		FallbackType = "Portal",
		DefaultScale = 1,
		Description = "Rebirth portal visual from the live plot model.",
	},
	DailyRewardChest = {
		Path = { "Workspace", "GameWorld", "Stations", "DailyRewardChest" },
		FallbackType = "Chest",
		DefaultScale = 1,
		Description = "Daily chest station visual from the live central station.",
	},
	VoidCrumbPickup = {
	...
	VoidShardPickup = {
		...
		FallbackType = "Pickup",
		DefaultScale = 1,
		Description = "Rare shard pickup; uses the void crumb pickup mesh until a dedicated shard is imported.",
	},
}
