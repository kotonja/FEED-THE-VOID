...
local warnedMissing = {}
local feedbackCategories = { "Bug", "Confusing", "TooSlow", "TooHard", "UIIssue", "MobileIssue", "Fun", "Other" }
...
function UIController.Init(ui, notifications, guidance, sounds)
	...
	if watermark then
		...
		watermark.Text = "PRIVATE TEST | " .. tostring(GameConfig.BuildVersion or GameConfig.Phase or "Phase 11")
	end
	bindRemotes()
